...
typedef Eigen::Matrix<double,Eigen::Dynamic,1,0,100,1> PulseVector;
typedef Eigen::Matrix<char,  Eigen::Dynamic,1,0,100,1> BXVector;
...
typedef Eigen::Matrix<double,Eigen::Dynamic,Eigen::Dynamic,0, 100, 100> PulseMatrix;
